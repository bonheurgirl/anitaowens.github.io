SET Unicode=Yes.
DATA LIST FILE='st2174valjarbar01.DAT' 
/
CODERESP 1-10
ENDDATE 11-20(EDATE)
ENDTM 21-28(A)
...
GENDER 379-388
BIRTHYEAR 389-398
MUNICIPALITY 399-408
SWEEDUCATION 409-418
VOTE2014 419-428
CIVILSTAND 429-438
INCOME 439-448
SYSSELSATTNING 449-458
.
EXECUTE.
SAVE OUTFILE 'st2174valjarbar01.sav'.

GET FILE 'st2174valjarbar01.sav'.

VARIABLE LABELS
CODERESP "Respondent"
ENDDATE "Enddate"
ENDTM "Endtime"
AS1001 "Välkommen till undersökningen!   Det tar bara några minuter att besvara. En del frågor kanske du känner igen sedan tidigare, men vi ställer även några nya spännande dagsaktuella frågor.   Tack för din medverkan!   Om det vore val till riksdagen idag,"
AS1002 "Men vilket parti lutar det mest mot för dig?"
AS1003 "Är det något parti som du tycker är mindre dåligt än de andra?"
AS1004 "Var du röstberättigad vid senaste riksdagsvalet, alltså i september 2014?"
AS1005 "Vilket parti röstade du på i riksdagsvalet 2014?"
BS1001 "Välkommen till undersökningen!   Det tar bara några minuter att besvara. En del frågor kanske du känner igen sedan tidigare, men vi ställer även några nya spännande dagsaktuella frågor.   Tack för din medverkan!   Om det vore val till riksdagen idag,"
BS1002 "Men vilket parti lutar det mest mot för dig?"
BS1003 "Är det något parti som du tycker är mindre dåligt än de andra?"
BS1004 "Var du röstberättigad vid senaste riksdagsvalet, alltså i september 2014?"
BS1005 "Vilket parti röstade du på i riksdagsvalet 2014?"
...
*RECODE AS1001 AS1002 AS1003 AS1004 AS1005 BS1001 BS1002 BS1003 BS1004 BS1005
CS1001 CS1002 CS1003 CS1004 CS1005 DS1001 DS1002 DS1003 DS1004 DS1005 ES1001
ES1002 ES1003 ES1004 ES1005 FS1001 FS1002 FS1003 FS1004 FS1005 GS1001 GS1002
GS1003 GS1004 GS1005 (99999999 = 99999997).


*RECODE AS1001 AS1002 AS1003 AS1004 AS1005 BS1001 BS1002 BS1003 BS1004 BS1005
CS1001 CS1002 CS1003 CS1004 CS1005 DS1001 DS1002 DS1003 DS1004 DS1005 ES1001
ES1002 ES1003 ES1004 ES1005 FS1001 FS1002 FS1003 FS1004 FS1005 GS1001 GS1002
GS1003 GS1004 GS1005 (99999999 = 99999998).
...
EXECUTE.
SAVE OUTFILE 'st2174valjarbar.sav'
.
